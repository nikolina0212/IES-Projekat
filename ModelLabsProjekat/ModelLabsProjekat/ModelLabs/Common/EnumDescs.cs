...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			property2enumType.Add(ModelCode.PAM_USAGE, typeof(AssetModelUsageKind));
			property2enumType.Add(ModelCode.PAM_CSK, typeof(CorporateStandardKind));
			property2enumType.Add(ModelCode.SEAL_KIND, typeof(SealKind));
			property2enumType.Add(ModelCode.SEAL_CON, typeof(SealConditionKind));
